...
public class ExpenseController {
    ...
    public ResponseEntity<ExpenseDTO> updateExpense(@PathVariable Long expenseId, @RequestBody UpdateExpenseDTO dto) {
        ExpenseDTO expenseDTO = service.updateExpense(expenseId, dto);
